    ...
    <section className="bg-[#f5f5f5] py-14">
      <div className="mx-auto max-w-[96rem]">
        ...
        <div className="mb-12 flex flex-col justify-between gap-8 px-8 md:flex-row md:px-14">
          {/* Left */}
          <h2 className="max-w-2xl text-4xl font-semibold leading-[0.95] tracking-[-0.05em] text-[#111] md:text-7xl">
            Siliguri's Most
            <br />
            Coveted Homes
          </h2>
      ...
      Townhouses
        ...
        <div className="group relative overflow-hidden rounded-[2rem]">
          <img
            ...
            alt="Europa Siliguri"
            className="h-[80vh] w-full object-cover transition duration-700 group-hover:scale-105"
          />

          <div className="absolute inset-0 bg-black/30" />

          {/* Play Button */}
          <button className="absolute left-1/2 top-1/2 flex h-16 w-16 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-white/15 text-white backdrop-blur-md transition hover:scale-110">
            <Play
              fill="currentColor"
