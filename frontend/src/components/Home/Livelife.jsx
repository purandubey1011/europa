    ...
    <section className="bg-[#f3f3f3] py-14">
      <div className="mx-auto max-w-[96rem] px-0">
        ...
        <div className="mb-16 grid items-start gap-10 px-8 md:px-14 lg:grid-cols-[1.15fr_1fr]">
          <h2 className="text-5xl font-semibold leading-[1.05] tracking-[-0.04em] text-[#111] md:text-7xl">
            Live Life,
            <br />
            Leisurely
          </h2>

          <div className="grid gap-x-14 gap-y-6 sm:grid-cols-2">
            ...
            <button className="flex w-fit items-center gap-3 rounded-xl bg-[#C6A12D] px-5 py-3 text-xs font-medium uppercase text-white sm:col-span-2 sm:ml-[21.5vw]">
              Download Brochure
        ...
        <div className="group relative w-full overflow-hidden rounded-2xl">
          <img
            ...
            alt="Europa Siliguri"
            className="h-[80vh] min-h-[28rem] w-full object-cover transition duration-700 group-hover:scale-105"
          />

          <div className="absolute inset-0 bg-black/45" />

          <button className="absolute left-1/2 top-1/2 flex h-16 w-16 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-white/30 text-white backdrop-blur-md transition hover:scale-105 hover:bg-white/40">
