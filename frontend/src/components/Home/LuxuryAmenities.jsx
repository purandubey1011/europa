    ...
    <section className="overflow-hidden bg-[#f5f5f5] py-16">
      <div className="mx-auto max-w-[96rem]">
        <div className="mb-14 flex flex-col justify-between gap-8 px-8 md:flex-row md:items-start md:px-14">
          <h2 className="text-5xl font-semibold leading-[1.05] tracking-[-0.05em] text-[#111] md:text-7xl">
            Live Life,
            <br />
            Luxuriously
          </h2>
          ...
          <div className="md:text-right">
            ...
            <button className="mt-6 inline-flex items-center gap-3 rounded-xl bg-[#C6A12D] px-5 py-3 text-xs font-medium uppercase text-white">
              Amenities
